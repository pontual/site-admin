...
$uploadfile_pdf = $tabelas_target_pdf . "estoque_" . "{$randomkey}.pdf";
// $uploadfile_xls = $tabelas_target_xls . "estoque_" . "{$randomkey}.xls";
...
if ($_FILES["arquivo_pdf"]["error"] === 0 && $_FILES["arquivo_htm"]["error"] === 0) {
