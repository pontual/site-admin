...
<html>
    <head>
        ...
        <?php require_once("stylesheetsIndex.html"); ?>
    </head>
    <body>
        ...
        <div data-role="page" data-theme="a" data-title="Pontual Import Brindes - Pontual Exportação e Importação Ltda. - <?php echo $page_title ?>" data-ajax="false" id="tabela-page">
